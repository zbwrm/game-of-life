...
HD_PWD='C:/Users/aoleary/Documents/GitHub/game-of-life/vivado project/game_of_life.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CELL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CELL.tcl
